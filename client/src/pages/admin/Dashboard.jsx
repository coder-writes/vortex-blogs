...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try{
      ...
      data.success===true ? setDashboardData(data.dashboardData) : toast.error(data.message || "Error fetching dashboard data");
    }catch(err){
  ...
  return (
    ...
    <div className='flex flex-wrap gap-4'>
      <div className='flex items-center gap-4 bg-white p-4 win-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all pr-15'>
