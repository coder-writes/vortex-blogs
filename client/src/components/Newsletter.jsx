    ...
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      <p className='md:text-lg text-gray-500/70 pb-8'>Subscribe to our newsletter to stay updated on the latest blog posts.</p>
        ...
        <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
          <input type="text" placeholder="Enter your email" className='border border-gray-300 rounded-md h-full border-r-0 outline-none w-full rounded-r-none px-3 text-gray-500' />
