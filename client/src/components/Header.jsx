...
const Header = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center gap-4 mt-8 mb-10'>
     {input && <button className='border font-light text-xxs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer' onClick={() => {setInput(''); inputRef.current.value = '';}}>Clear Search</button>}
    </div>
